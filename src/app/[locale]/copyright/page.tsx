        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              Email: <a href="mailto:dmca@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animestory2wiki.wiki</a>
            </p>
            <p>
            ...
            <p>
              Example attribution: <em>"Source: Anime Story 2 Wiki (animestory2wiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animestory2wiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animestory2wiki.wiki</a>
            </p>
            <p>
