...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://animestory2wiki.wiki";
    ...
    "@graph": [
      {
        ...
        description:
          "Anime Story 2 Wiki offers Roblox codes, unit tier lists, traits, bosses, worlds, and beginner progression guides.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Anime Story 2 Roblox gameplay artwork",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        url: siteUrl,
        description:
          "Anime Story 2 Wiki resource hub for codes, units, traits, bosses, worlds, tier lists, and update notes.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Anime Story 2 Wiki hero image",
        },
        sameAs: [
          "https://www.roblox.com/games/116877041621051/Anime-Story-2",
          "https://discord.com/servers/anime-story-2-1419418821110009939",
          "https://www.reddit.com/r/roblox",
          "https://www.youtube.com/@AnimeStory2",
        ],
      },
      {
        "@type": "VideoGame",
        ...
        offers: {
          ...
          url: "https://www.roblox.com/games/116877041621051/Anime-Story-2",
        },
      },
      {
        "@type": "VideoObject",
        name: "Anime Story 2 Black Clover Update 0.5 Guide",
        description:
          "Gameplay guide and showcase for Anime Story 2 update 0.5, including units and secret boss locations.",
        uploadDate: "2026-05-01",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/Ity6X6yXmrc",
        url: "https://www.youtube.com/watch?v=Ity6X6yXmrc",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              <a
                href="https://www.youtube.com/watch?v=Ity6X6yXmrc"
                target="_blank"
              ...
              <a
                href="https://www.roblox.com/games/116877041621051/Anime-Story-2"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 md:px-8 md:py-4
              ...
              >
                {t.hero.playOnRobloxCTA ?? "Play on Roblox"}
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="Ity6X6yXmrc"
              title="Anime Story 2 Black Clover Update 0.5 Guide"
            />
          </div>
        </div>
      </section>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.com/servers/anime-story-2-1419418821110009939"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://youtube.com/watch?v=Ity6X6yXmrc"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
