...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Anime Story 2 Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Anime Story 2 Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Anime Story 2 Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              master the Steam game "Anime Story 2". We are a community-driven platform that provides comprehensive guides,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              ...
              endorsed by, or associated with the developers of Anime Story 2 or any official entities.
            </p>
            <p>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@animestory2wiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@animestory2wiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@animestory2wiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@animestory2wiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@animestory2wiki.wiki
                </a>
              </div>
            </div>
